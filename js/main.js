...
var main = (function () {
    ...
    var configs = (function () {
        ...
        Singleton.defaultOptions = {
            general_help: "There's a list of commands that you can use.\nYou can use autofill by pressing the TAB key.",
            ...
            welcome: "Welcome user \n Here's Daniel Cifuentes, I'm a Software Engineer student, a web developer and sometimes an amateur photographer.\nFeel free to use help command for further information, or you can use the side navigation.\nIn order to skip text rolling, double click/touch anywhere.",
            internet_explorer_warning: "NOTE: I see you're using internet explorer, this website won't work properly.",
            welcome_file_name: "welcome_text.txt",
    ...
    var files = (function () {
        ...
        Singleton.defaultOptions = {
            "interests.txt": "My interests are mostly:\n  - PHP\n- Javascript\n- Laravel Framework\n- iOS development\n And of course photography",
            "academic_info.txt": "Current\n Universidad Nacional de Colombia, Degree in Computer Engineering\nMain subjects:\n- Software Engineering \n- Internet Computing\n- Object Oriented Programming\n- Distributed Computing\n- Databases\n- Operating Systems",
            "linkedin.txt": "https://www.linkedin.com/in/danielcifuentesg/",
            "github.txt": "https://github.com/jdcifuentes",
            "flickr.txt": "https://www.flickr.com/photos/101386475@N03/",
            "this_website.txt": "This website was based on luisbraganca's fake-terminal-website,  an awesome project and really easy to set up, fell free to visit his repo here: https://github.com/luisbraganca/fake-terminal-website/",
        };
        return {
            getInstance: function (options) {
                instance === void 0 && (instance = new Singleton(options));
